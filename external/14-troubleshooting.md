...
**Известный баг.** На странице «Услуги» может показываться «Ваш уровень подписки содержит **undefined** ключевых услуг». Это **визуальная ошибка**, подписка работает нормально.
...
1. Откройте чат с ботом RSpace в Telegram (тот, к которому привязали аккаунт).
...
Возможные причины:
- TTL токена истёк (1 день обычно, около месяца с Remember Me — длина календарного месяца).
