...
- **AI-юрист Грут** — 🚧 **в разработке.** Запуск — после подписки тарифа Премиум и выше; функция появится в кабинете автоматически. Подробности — ниже.
...
> 🚧 **Статус: в разработке.** Сейчас фича недоступна в кабинете. Мы её строим — появится в одном из ближайших обновлений на тарифах Премиум и выше. Те, кто подключит Премиум сейчас, получат AI-юриста автоматически, как только он будет включён.
...
Чат-бот на основе GPT, обученный на типовых юридических кейсах российской недвижимости. Будет отвечать на быстрые вопросы 24/7:
...
Начиная с **Премиума** (включительно). На Триале и Профи AI-юрист не появится — это один из ключевых апсейлов при переходе с Профи на Премиум.

### Как будет пользоваться (план)

1. В кабинете → меню → **«AI-юрист»**.
2. Задать вопрос в свободной форме.
3. Ответ — через 5-15 секунд.

Когда фича включится, в Telegram-боте RSpace и в кабинете появится уведомление.
...
![Витрина услуг в кабинете — место, где заказываются юристы и проверки](../assets/screenshots/lk/lk-services-shelf.png)
...
О: AI-юрист сейчас в разработке. Когда запустим, он будет советчиком по общим вопросам — не заменит живого юриста на сделку. Сделки и сейчас закрываются услугой «Юрист на сделку».
...
О: Готовим — запросов много. Пишите в поддержку, вышлем текущие наработки.
...
- **AI-юрист Грут** — 🚧 в разработке. Будет доступен начиная с Премиума (Премиум / Ультима / Энтерпрайс). На Триале и Профи не появится.
...
*Юридические вопросы — не экспериментируйте. Если что-то непонятно — пишите в поддержку, для сделок оформляйте «Юрист на сделку». AI-юрист появится в одном из ближайших обновлений.*
