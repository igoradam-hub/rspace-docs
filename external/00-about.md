...
![Главный экран лендинга: «Зарабатывайте больше с каждой сделки» + иконки классифайдов](../assets/screenshots/landing/landing-hero-desktop.png)
...
- **AI-юрист Грут** 🚧 *в разработке* — будет доступен с Премиума. Быстрые консультации по юридическим вопросам 24/7.
...
![Блок «О сервисе» с числовой полоской 12/3/8/24·7](../assets/screenshots/landing/landing-about-section.png)
...
- **Банки по ипотеке:** Альфа-Банк, Ренессанс Банк, Дом.РФ — действующие партнёры (заявки клиентов идут через платформу). Сюда не входит технические API-интеграции — это business-партнёрства, заявки маршрутизируются вручную брокером.
- **Страховщики:** подбор страховых продуктов; пул аккредитованных партнёров уточняется у брокера.
- **Юристы:** собственная команда юристов RSpace; AI-юрист Грут — *в разработке*, появится в одном из ближайших обновлений на Премиум-тарифах и выше.

## Тарифы

![Блок «RSpace PRO» — профессиональное коммьюнити для опытных риелторов](../assets/screenshots/landing/landing-rspace-pro.png)

| Тариф | Москва | Регионы | Объектов | AI-юрист (в разработке) |
|---|---|---|---:|---|
| Триал | бесплатно 30 дней | бесплатно 30 дней | 3 | нет |
| **Профи** | **5 000 ₽/мес** | **4 000 ₽/мес** | 3 | нет |
| **Премиум** | **9 000 ₽/мес** | **7 000 ₽/мес** | 5 | **войдёт после запуска** |
| **Ультима** | **17 000 ₽/мес** | **13 000 ₽/мес** | 10 | войдёт после запуска |
| **Энтерпрайс** | **по запросу** | **по запросу** | **15** | войдёт после запуска |
...
- **AI-юрист Грут** — 🚧 в разработке. После запуска включится автоматически на тарифах Премиум / Ультима / Энтерпрайс. На Триале и Профи не будет включён.
