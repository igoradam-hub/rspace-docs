...
> **Для кого:** риелтор, выбирающий тариф; сотрудник поддержки, отвечающий на вопросы по биллингу.
> **Сложность:** базовая
> **Последнее обновление:** 2026-04-23 (сверено с актуальной моделью от 23.04.2026)
...
**Профи.** 5 000 ₽ (или 4 000 ₽ для регионов) за публикацию на классифайдах (сейчас — Авито и ЦИАН; ДомКлик и Яндекс.Недвижимость подключим в ближайшем обновлении), шаблоны договоров и одну бесплатную подготовку ДКП — уже окупает ручные размещения. Юрист по сделкам — отдельно со скидкой 20%.

### Средний риелтор, 3-5 объектов, 1-2 сделки, иногда нужна ипотека
**Премиум.** 9 000 ₽ (7 000 ₽ для регионов) — ключевая добавка: **AI-юрист Грут** (которого нет на Профи), 2 бесплатных подготовки ДКП, 2 ипотечных брокера в месяц. По CusDev это «базовая точка» для опытного агента.
...
**Энтерпрайс.** 20 000 ₽/мес — 15 объектов в рекламе, 3 брокера, 3 подготовки ДКП, AI-юрист, максимальная скидка на услуги −30%. Индивидуальные условия по агентской комиссии с банков/страховых и дополнительным интеграциям — обсуждаются в личном порядке. Пишите в поддержку, если у вас стабильно более 10 объектов или отдельные требования к аналитике/отчётам.
...
Для сравнения: один юрист со стороны («по знакомству») — 8-15 000 ₽ за сделку без учёта проверок и публикаций, и без агентская комиссияа от банков.
