...
| **AI-юрист Грут** *(🚧 в разработке)* | нет | нет | войдёт после запуска | войдёт после запуска | войдёт после запуска |
...
**Премиум.** 9 000 ₽ (7 000 ₽ для регионов) — ключевая добавка: 2 бесплатных подготовки ДКП, 2 ипотечных брокера в месяц + **AI-юрист Грут** *(сейчас в разработке, включится автоматически после запуска)*. Это базовая точка для опытного агента.
...
- **AI-юрист сейчас в разработке** — после запуска включится только на Премиуме и выше; на Триале и Профи доступен не будет.
...
Активные промокоды раздаём адресно — например, в email-рассылке после регистрации, у партнёров или менеджеру в личной переписке. Если получили код — введите его в форме оплаты до подтверждения. Список действующих промокодов публично не публикуем, чтобы лимит активаций не выгорел.

## Частые вопросы

**В: У меня свой юрист, дешевле. Есть смысл брать Премиум?**
О: Если сделок мало — Профи достаточно. Премиум добавляет увеличенное бесплатное наполнение (+1 подготовка ДКП, +1 ипотечный брокер) и в одном из ближайших обновлений включит **AI-юриста** (консультации 24/7, сейчас в разработке). Если ваш юрист стоит меньше и работает быстро — можно оставаться на нём и брать RSpace только ради публикаций на Профи.
...
О: Нет. AI-юрист сейчас в разработке; когда запустим, он будет отвечать на юридические вопросы, объяснять нюансы, помогать формулировать документы. Для сопровождения сделки и подписи ДКП всегда нужен живой юрист — заказывайте услугу «Юрист на сделку» (со скидкой по тарифу).
