...
![Блок «Кошелёк» крупно: 99 516 баллов (для оплаты услуг), 89 000 рублей (доступно к выводу)](../assets/screenshots/lk/lk-dashboard-wallet.png)
...
- Активные промокоды публично не перечисляем (раздаём адресно — рассылка, партнёры, поддержка). Если у вас есть код — просто введите в форме оплаты.
